...
import {
  SpotifyTracksItemData,
  SpotifyPlaylistsData,
  SpotifyFavoriteArtistItemData,
  SpotifyRecentlyPlayedItemData
...
export const fetchFavoriteTracks = createAsyncThunk(
  '/user/favoriteTracks',
  async (payloadData: FetchFavoriteTracksData) => {
    const { data } = await spotifyApi.fetchFavoriteTracks(
      payloadData.loginData,
      payloadData.params
    );
    return data;
  }
...
export const fetchRecentlyPlayed = createAsyncThunk(
  '/user/recently',
  async (payloadData: FetchRecentsData) => {
    const { data } = await spotifyApi.fetchRecentlyPlayed(
      payloadData.loginData,
      payloadData.params
    );
    return data;
...
export const fetchFavoriteArtists = createAsyncThunk(
  ...
  async (payloadData: FetchFavoriteArtistsData) => {
    const { data } = await spotifyApi.fetchFavoriteArtists(
      payloadData.loginData,
      payloadData.params
    );
    return data;
